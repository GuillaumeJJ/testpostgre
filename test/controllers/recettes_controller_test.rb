...
class RecettesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recette" do
    assert_difference('Recette.count') do
      post recettes_url, params: { recette: { ingredients: @recette.ingredients, nom: @recette.nom, photo: @recette.photo } }
    end
  ...
  test "should update recette" do
    patch recette_url(@recette), params: { recette: { ingredients: @recette.ingredients, nom: @recette.nom, photo: @recette.photo } }
